...
namespace CustomControlLibrary.CustomBaseControl
{
    ...
    ///
    ///     <MyNamespace:BaseComboBox/>
    ///
    /// </summary>
    public class BaseComboBoxControl : BaseCustomControl
    {
        static BaseComboBoxControl()
        {
            DefaultStyleKeyProperty.OverrideMetadata(typeof(BaseComboBoxControl), new FrameworkPropertyMetadata(typeof(BaseComboBoxControl)));
        }
    }
}
